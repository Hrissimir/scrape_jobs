...
from scrape_jobs.sites.seek_com_au import seek_result
from scrape_jobs.sites.seek_com_au.seek_search_context import SeekSearchContext


class SeekResults(ResultsContext):
    ...
    def get_visible_results(self) -> List[dict]:
        return [seek_result.parse_result_element(e)
                for e
...
class SeekPage(SeekSearchContext, SeekResults, JobsPage):
    def __init__(self):
